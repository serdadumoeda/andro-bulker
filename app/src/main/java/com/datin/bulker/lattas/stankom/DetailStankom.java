...
public class DetailStankom extends AppCompatActivity {
    ...
    public void lihat(View view){
        ...
        intent.setClass(DetailStankom.this, PentaTenagaKerjaAsing.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://buletinnaker.kemnaker.go.id/storage/coverlattas/"+ StankomItem.getFile()).into(imgVIew);
