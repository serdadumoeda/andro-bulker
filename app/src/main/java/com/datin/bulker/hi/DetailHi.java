...
public class DetailHi extends AppCompatActivity {
    ...
    public void lihat(View view){
        ...
        intent.setClass(DetailHi.this, PentaTenagaKerjaAsing.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://buletinnaker.kemnaker.go.id/storage/coverlattas/"+HiItem.getFile()).into(imgVIew);
